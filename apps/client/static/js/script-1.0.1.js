...
$(function() {
	...
	if (params.access_token){
		...
		var picture_url = data.picture_endpoint;
	
		$.getJSON(userinfo_url, function(data) {
			...
			$.each(data, function(key, val) {
				...
				if (key == 'picture'){
					...
					if (picture_url) {
						...
						item = '<tr><td>'  + key + '</td><td><image src=' + JSON.stringify(val) + ' width="100px" /></td></tr>';
					}
				}
